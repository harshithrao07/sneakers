...
export default function Signup() {
    ...
    return (
        <div className="font-body w-full flex justify-center">
            <Form method="post" className="flex flex-col mt-24 mb-6 w-fit items-center p-5 login-card">
                ...
                <button className="py-2 px-3 bg-primary-200 text-white font-bold text-sm rounded-md">Sign Up</button>
            </Form>
        </div>
    )
}